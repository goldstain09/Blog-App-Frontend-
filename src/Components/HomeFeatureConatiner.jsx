          ...
          <div className="row d-flex">
            <div className="card Features col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4">
              <div className="card-body">
                ...
                You can see your blogs activities, like who is following you or commenting on your blogs!
                </p>
              </div>
            </div>
            <div className="card Features col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4">
            ...
            <div className="card Features col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4">
              <div className="card-body">
                <h5 className="card-title">Like, Comments & Save-</h5>
                <h6 className="see_how">-----</h6>
                <p className="card-text">
                 You can comment on other's blogs and also do like or save!
                </p>
              </div>
            </div>
          </div>
