...
export const postABlog = async (data) => {
  try {
    const response = await axios.post("/v1/PostApi/PostaBlog", data, {
      headers: {
...
export const getPostData = async (data) => {
  try {
    const response = await axios.get(`/v1/PostApi/getPostData/${data.postId}`, {
      headers: {
        Authorization: `Bearer ${data.token}`,
      },
    });
...
export const updateBlog = async (data) => {
  try {
    const response = await axios.put(`/v1/PostApi/updateBlog`, data, {
      headers: {
        Authorization: `Bearer ${data.token}`,
      },
    });
...
export const deleteBlog = async (data) => {
  try {
    const response = await axios.delete(
      `/v1/PostApi/deleteBlog/${data.postId}`,
      {
        headers: {
          Authorization: `Bearer ${data.token}`,
        },
...
export const getAllPostsData = async (token) => {
  try {
    const response = await axios.get("/v1/PostApi/getAllPosts", {
      headers: {
...
export const likePost = async (data) => {
  try {
    const response = await axios.put("/v1/PostApi/likePost", data, {
      headers: {
        Authorization: `Bearer ${data.token}`,
      },
    });
...
export const unlikePost = async (data) => {
  try {
    const response = await axios.put("/v1/PostApi/unlikePost", data, {
      headers: {
        Authorization: `Bearer ${data.token}`,
      },
    });
...
export const savePost = async (data) => {
  try {
    const response = await axios.put("/v1/PostApi/savePost", data, {
      headers: {
        Authorization: `Bearer ${data.token}`,
      },
    });
...
export const unsavePost = async (data) => {
  try {
    const response = await axios.put("/v1/PostApi/unsavePost", data, {
      headers: {
        Authorization: `Bearer ${data.token}`,
      },
    });
...
export const postComment = async (data) => {
  try {
    const response = await axios.put("/v1/PostApi/postComment", data, {
      headers: {
        Authorization: `Bearer ${data.token}`,
      },
    });
...
export const deleteComment = async (data) => {
  try {
    const response = await axios.put("/v1/PostApi/deleteComment", data, {
      headers: {
        Authorization: `Bearer ${data.token}`,
      },
    });
